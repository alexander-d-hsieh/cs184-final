...
Object::Object(double width, double height, double depth, int num_width_points,
...
void Object::simulate(double frames_per_sec, double simulation_steps, ObjectParameters *op,
